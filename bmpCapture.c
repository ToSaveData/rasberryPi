...
void saveImage(unsigned char *inimg)
{
	...
	bmpFileHeader.bf0ffBits = sizeof(BITMAPFILEHEADER) + sizeof(BITMAPINFOHEADER);
	bmpFileHeader.bf0ffBits += sizeof(RGBQUAD) * 256;
	bmpFileHeader.bfSize = bmpFileHeader.bf0ffBits;
