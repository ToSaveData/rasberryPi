...
int main()
{
	Scalar orange(0, 165, 255), blue(255, 0, 0), magneta(255, 0, 255);
	...
	ellipse(image, pt2, Size(100, 60), 30, 30, 360, orange, 2);
	ellipse(image, pt2, Size(100, 60), 30, -30, -160, magneta, 4);
