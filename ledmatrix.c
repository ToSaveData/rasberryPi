...
int main(void)
{
	...
	*(pfb+1+1*vinfo.xres) = makepixel(255, 128, 0);
	*(pfb+2+2*vinfo.xres) = makepixel(255, 255, 0);
	*(pfb+3+3*vinfo.xres) = makepixel(0, 255, 0);
	*(pfb+4+4*vinfo.xres) = makepixel(0, 0, 255);
	*(pfb+5+5*vinfo.xres) = makepixel(0, 0, 153);
